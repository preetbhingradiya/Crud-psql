...
const SAME_TODO_NAME = `SELECT * FROM todo WHERE todo LIKE $1`
...
module.exports = { GET_ALL_TODOS, ADD_TODO, SAME_DATE_TODO,SAME_TODO_NAME ,ASC_NAME, DESC_NAME, FILTER_DATE, EDIT_TODO, UPDATE_TODO, DELETE_TODO }